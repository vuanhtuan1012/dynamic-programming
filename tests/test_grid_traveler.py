...
# @Last Modified time: 2022-04-09 23:37:06
...
class GridTraveler(unittest.TestCase):
    def test_gridTraveler11(self):
        self.assertEqual(gridTraveler(1, 1, dict()), 1)

    def test_gridTraveler23(self):
        self.assertEqual(gridTraveler(2, 3, dict()), 3)

    def test_gridTraveler32(self):
        self.assertEqual(gridTraveler(3, 2, dict()), 3)

    def test_gridTraveler33(self):
        self.assertEqual(gridTraveler(3, 3, dict()), 6)
